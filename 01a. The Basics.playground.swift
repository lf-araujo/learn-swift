/// # Learn Swift
/// 
/// This is my fork adapting contents from https://github.com/nettlep/learn-swift to Swift 4
/// 
...
/// You can combine them on a single line with a comma, but Swift style practices require variables
/// with more than 3 characters and less than 40
let a = 10, b = 20, c = 30
...
/// In the REPL one can just put the raw string on the line, which is an expression

...
///For functions wo return values one removes the return type (and the -> delimiter) alltogether:
...
///If your internal and external names are the same, one only needs to name it internally:
...
func addMul(_ firstAdder: Int, _ secondAdder: Int, multiplier: Int = 1) -> Int {
...
func doDoMul(_ doMulFunc: (Int, Int) -> Int, a: Int, b: Int) -> Int {
